...
<link href="/xiaoxukunboke/Application/Home/public/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
...
<div class="banner banner2">
	 <div class="container">
		 <div class="headr-right">
				<div class="details">
					<ul>
						<li><a href="mailto:@example.com"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>邮箱：10000@qq.com</a></li>
								 ...
								 <li class="dropdown">
									<a href="#" class="scroll dropdown-toggle" data-toggle="dropdown">博客<b class="caret"></b></a>
									 <ul class="dropdown-menu">
										<li><a href="review.html">文章列表</a></li>
...
<div class="container">
				<div class="single">
					<div class="blog-to">		
						...
						<!-- <img class="img-responsive sin-on" src="/xiaoxukunboke/Application/Home/public/images/sin1.jpg" alt="" /> -->
							<div class="blog-top">
							<div class="blog-left">
								
								<span><?php echo (date("Y-m-d H:i:s ",$news_time)); ?></span>
							</div>
							<div class="top-blog" style="text-align: center ">
								<a class="fast" href="#"><?php echo ($news_title); ?></a>
								<p><?php echo ($news_author); ?></p> 
								<p class="sed" > <?php echo ($news_content); ?></p>
