					 ...
					 <nav class="navbar navbar-default">
						 ...
						 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							 <ul class="nav navbar-nav">
								 ...
								 <li class="active"><a href="/xiaoxukunboke/index.php/Home/Contact/xiangce">相册</a></li>
	 ...
	 <div class="container">
		 ...
		 <div class="gallery-bottom">
				<div class="gallery-1">
                     ...
                     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="margin-top: 10px" class="col-md-3 gallery-grid">
						<a class="example-image-link" href="/xiaoxukunboke/<?php echo ($vo["pic_src"]); ?>" data-lightbox="example-set">
						<img class="example-image" src="/xiaoxukunboke/<?php echo ($vo["pic_src"]); ?>" alt=""/></a>
