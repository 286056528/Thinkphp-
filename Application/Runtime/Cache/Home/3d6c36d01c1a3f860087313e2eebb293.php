...
<html lang="en-US">
	...
	<body>
	   ...
	   <div class="banner" style="background:url(/Application/pub/img/erp.jpg) no-repeat center center;background-size:cover;"><img src="/Application/pub/img/p6.png" alt="" /></div>
	   
	   
	   <div class="bg" style="background:url(/Application/pub/img/ring.jpg) no-repeat center center;background-size:cover;"> 
			<div class="cont2" style="width:84%;padding-top:8%;"> 
				     <div class="imac"> 
				           <dt><?php echo ($rj_title); ?></dt>
						   <dd>ERP<br />SYSTEM</dd>
						   <p style="height: 300px"><?php echo ($rj_content); ?></p>
				     </div>

		         <div class="clear" style="padding-bottom:3%;"></div>
				  <div class="cont"> 
						<div class="home"> 
							<dt>核心功能展示</dt>
							<dd>CORE FUNCTION DISPLAY</dd>
						</div>				  
				  </div>
                    ...
                    <?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["rjtype_id"] == 4): ?><li> 
						      <label><img src="/<?php echo ($vo["rj_pic"]); ?>" alt="" /></label>
...
<!--底部栏结束-->
	...
	$(function(){
    var $wiw=$('.tong li').eq(0).width();
	$('.tong li p').width(0.98*$wiw);
