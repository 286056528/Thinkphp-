                    ...
                    <div class="ibox-content">
                        ...
                        <div class="text-center article-title">
                         ...
                         <div class="pull-right">
                            <span class="btn btn-white btn-xs" >位置：</span>
                            <span class="btn btn-white btn-xs" ><?php echo ($loc_loc); echo ($loc_name); ?></span><br/><br/>
                            <span class="btn btn-white btn-xs" ><?php echo (date("Y 年 m 月 d 日  H:i:s",$inc_time)); ?></span>
                        </div><br/><br/><br/>
                        </div>
