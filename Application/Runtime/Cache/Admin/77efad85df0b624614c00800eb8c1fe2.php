                        ...
                        <div class="alert alert-info">
                          请在此选择需要添加的图片。只能选择一张！！
                            ...
                            <div class="form-group draggable">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="rj_title" id="rj_title" class="form-control" placeholder="标题：">
                               ...
                               <div class="form-group draggable">
                                ...
                                <div class="col-sm-9">
                                    <select id="rjtype_id" class="form-control" style="height: 98%" name="">
                                         <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo["rjtype_id"]); ?>"><?php echo ($vo["rjtype_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group draggable">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" name="rj_content" id="rj_content" class="form-control" > </textarea>
                         ...
                         <div class="hr-line-dashed" style="margin: 200px 0 0 0"></div>
                            <div class="form-group draggable">
                                <div class="col-sm-12 col-sm-offset-3">
                                    <button id="addrjgnme" class="btn btn-primary" type="button" onclick="addrjgnme()">提交</button>&nbsp;&nbsp;
...
$(function(){
    ...
    function addrjgnme(){
        ...
        var url = "<?php echo U('addrjgnme');?>";
            $.ajax({
            type:'post',
            url:url,
            data:{"rjtype_id":rjtype_id,"rj_title":rj_title,"rj_pic":rj_pic,"rj_content":rj_content},
            dataType:'json',
