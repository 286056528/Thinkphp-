                    ...
                    <div class="ibox-content">
                        ...
                        <div class="text-center article-title">
                         ...
                         <div class="pull-right">
                            <span class="btn btn-white btn-xs" >留言人: <?php echo ($lm_name); ?></span><br/>
                            <span class="btn btn-white btn-xs" >电话：<?php echo ($lm_phone); ?></span><br/>
                           
                            <span class="btn btn-white btn-xs" ><?php echo (date("Y 年 m 月 d 日  H:i:s",$lm_time)); ?></span>
                        </div><br/><br/><br/><br/><br/><br/>
                        <span style="height: 20px"></span>
                        </div>
                      <!--  内容 --> &nbsp;&nbsp;&nbsp; <?php echo ($lm_content); ?>
                        <hr>
