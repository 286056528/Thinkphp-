            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                        <td><?php echo ($i); ?></td>
                        <td><?php echo ($vo1["call_call"]); ?></td>
                        <td><?php echo ($vo1["call_home"]); ?></td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo1["call_time"])); ?></td>
                        <td> 
                        <a value="<?php echo ($vo1["call_id"]); ?>"  class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/Content/editcall/call_id/<?php echo ($vo1["call_id"]); ?>">编辑</a>
