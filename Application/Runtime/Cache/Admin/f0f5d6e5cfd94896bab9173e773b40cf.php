...
<body class="gray-bg">
                   ...
                   <div class="ibox-content">
                        <div class="alert alert-info">
                          此处添加皆为首页信息！！ 非系统人员请勿随意添加
                            ...
                            <div class="form-group draggable">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="inc_title" id="inc_title" class="form-control" >
                                </div>
                            </div>
                        ...
                        <div class="form-group draggable">
                                ...
                                <div class="col-sm-12" style="height: 900px;width: 100%">
                                     ...
                                     <button id="addinc"style="margin: 20px 0px 10px 0px" class="btn btn-primary" type="button" onclick="addinc()">提交</button>
    ...
    <script type="text/javascript">
       ...
       // var content = ue.getContentTxt()
        var url = "<?php echo U('addinc');?>";

            $.ajax({
            type:'post',
            url:url,
            data:{"loc_id":loc_id,"inc_title":inc_title,"content":content},
            dataType:'json',
