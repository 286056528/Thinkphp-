...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                          <a   class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/Introduce/addrjgn">添加介绍</a>
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                        <td><?php echo ($i); ?></td>
                        <td><?php echo ($vo1["rjtype_name"]); ?></td>
                        <td><?php echo ($vo1["rj_title"]); ?></td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo1["rj_time"])); ?></td>
                        <td> 
                        <a value="<?php echo ($vo1["rj_id"]); ?>"  class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/Introduce/detailsrjgn/rj_id/<?php echo ($vo1["rj_id"]); ?>">详情</a>
                        <a value="<?php echo ($vo1["rj_id"]); ?>"  class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/Introduce/editrjgn/rj_id/<?php echo ($vo1["rj_id"]); ?>">编辑</a>
                        <button  value="<?php echo ($vo1["rj_id"]); ?>"  class="btn btn-sm btn-primary" onclick="deleterj(this.value)">删除</button> 
  ...
  function deleterj(value){
         //  alert(value);
        // 执行异步请求  $.post    
           var url = "<?php echo U('deleterj');?>";
            $.ajax({
            type:'post',
            url:url,
            data:{"value":value},
