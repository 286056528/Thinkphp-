            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                           <a   class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/News/addnewstype">添加类别</a>
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                        ...
                        <td><?php echo (date("Y-m-d H:i:s",$vo1["showtype_time"])); ?></td>
                        <td>
                        <?php if($vo1["type"] == 1): ?><span class="label label-primary">图文</span> 
                         <?php else: ?>
                        <span class="label label-default" >仅文字</span><?php endif; ?>
                        </td>
                        <td> 
                        <a   class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/News/edittype/showtype_id/<?php echo ($vo1["showtype_id"]); ?>">编辑</a>
                        <button  value="<?php echo ($vo1["showtype_id"]); ?>"  class="btn btn-sm btn-primary" onclick="deletest(this.value)">删除</button> 
