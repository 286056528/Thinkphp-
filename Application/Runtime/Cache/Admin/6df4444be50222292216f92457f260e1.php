...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                        <td><?php echo ($i); ?></td>
                        <td><?php echo ($vo1["coo_company"]); ?></td>
                        <td><?php echo ($vo1["coo_phone"]); ?></td>
                        <td><?php echo ($vo1["coo_name"]); ?></td>
                        <td><?php echo ($vo1["coo_qq"]); ?></td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo1["coo_time"])); ?></td>
                       
                        <td> 
                        
                        <button  value="<?php echo ($vo1["coo_id"]); ?>"  class="btn btn-sm btn-primary" onclick="deletecoo(this.value)">删除</button> 
  ...
  function deletecoo(value){
         //  alert(value);
        // 执行异步请求  $.post    
           var url = "<?php echo U('deletecoo');?>";
            $.ajax({
            type:'post',
            url:url,
            data:{"value":value},
