                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            <thead>
                            <a class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/Case/add">添加伙伴</a>
                              <a class="btn btn-sm btn-primary" style="margin-left: 10px" href="/xiaoxukunboke/index.php/Admin/Case/addlogo">添加LOGO</a>
                                <tr>
                                    <th>序号</th>
                                    <th>内容</th>
                                    <th>LOGO</th> 
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                        <td><?php echo ($i); ?></td>
                        <td><?php echo (mb_strcut($vo1["case_content"],0,100,'utf-8')); ?>...</td>
                         <td bgcolor="#512C2C"><img style="height: 50px;width: 80px;"  src="/xiaoxukunboke/<?php echo ($vo1["logo_url"]); ?>"></td> 
                          <td><img style="height: 50px;width: 80px;"  src="/xiaoxukunboke/<?php echo ($vo1["case_url"]); ?>"></td> 
                        <td><?php echo (date("Y-m-d H:i:s",$vo1["case_time"])); ?></td>
                       <td>

                       <a value="<?php echo ($vo1["case_id"]); ?>"  class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/Case/editcase/case_id/<?php echo ($vo1["case_id"]); ?>">编辑</a>
                        
                        <button  value="<?php echo ($vo1["case_id"]); ?>"  class="btn btn-sm btn-primary" onclick="deletecase(this.value)">删除</button> 
                        </td>
