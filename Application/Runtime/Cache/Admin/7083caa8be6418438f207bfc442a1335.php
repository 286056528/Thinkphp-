            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <a class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/Role/add">添加角色</a>
                ...
                <?php if(is_array($rolelist)): $i = 0; $__LIST__ = $rolelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><tr id="product1">
                        ...
                        <td> 
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i; if(in_array(($vo2["auth_id"]), is_array($vo1['role_auth_ids'])?$vo1['role_auth_ids']:explode(',',$vo1['role_auth_ids']))): echo ($vo2["auth_name"]); ?> |<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        </td>
                        <td><a class="btn btn-sm btn-primary" href="/xiaoxukunboke/index.php/Admin/Role/distribute/role_id/<?php echo ($vo1["role_id"]); ?>">权限修改</a></td>
