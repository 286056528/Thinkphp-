/* This file is created by MySQLReback 2017-06-26 11:47:37 */
 /* 创建表结构 `gw_auth` */
 ...
 DROP TABLE IF EXISTS `gw_inc`;/* MySQLReback Separation */ CREATE TABLE `gw_inc` (
  ...
  PRIMARY KEY (`inc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;/* MySQLReback Separation */
 /* 插入数据 `gw_inc` */
 INSERT INTO `gw_inc` VALUES ('4','1','木鸽简介','<p>重庆木鸽信息技术有限公司是一家专业从事定制家居行业专业ERP系统、C/S、B/S 及平台类项目等互联网项目开发的高科技企业。公司组织专业软件研发精英团队，集虚拟现实技术VR、ERP和OA于一体，专注研发智能家具加工工艺自动化系统，为企业实现办公自动化、效益最大化提供专业化优质服务。</p>','1498448494');/* MySQLReback Separation */
 /* 创建表结构 `gw_lmessage` */
 ...
 /* 插入数据 `gw_location` */
 INSERT INTO `gw_location` VALUES ('1','木鸽简介','01'),('2','核心技术','02'),('3','只能ERP','03'),('4','软件功能','04'),('5','解决方案','05'),('6','合作商家','06'),('7','案例展示','07'),('8','新闻资讯','08'),('9','联系方式','09');/* MySQLReback Separation */
 /* 创建表结构 `gw_log` */
...
　　在泼墨山水画里你从墨色深处被隐去</pre><p>&nbsp; &nbsp; &nbsp; <img src=\"/ueditor/php/upload/image/20170609/1496988546992614.png\" title=\"1496988546992614.png\" alt=\"zhoujiel.png\"/></p>','','/ueditor/php/upload/image/mugelogo.png','1496988571','1','0');/* MySQLReback Separation */
 ...
 DROP TABLE IF EXISTS `gw_pics`;/* MySQLReback Separation */ CREATE TABLE `gw_pics` (
  ...
  PRIMARY KEY (`pic_id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;/* MySQLReback Separation */
 /* 插入数据 `gw_pics` */
...
','','./Public/uploads/pic/20170426144422.pngxiaotu.png','1','0','1497838880'),('5','1','','D:/wamp/www/BScode1/Application/Admin/Controller/../Public/uploads/0.png','','./Public/uploads/pic/20170426144422.pngxiaotu.png','1','0','1497839066'),('8','1','','D:/wamp/www/BScode1/Application/Admin/Controller/../Public/uploads/20170416111617.jpg0.0540s ','','./Public/uploads/pic/20170426144422.pngxiaotu.png','1','0','1497841314'),('9','1','','D:/wamp/www/BScode1/Application/Admin/Controller/../Public/uploads/zhoujiel.png','','./Public/uploads/pic/20170426144422.pngxiaotu.png','1','0','1497841614'),('10','1','','D:/wamp/www/BScode1/Application/Admin/Controller/../Public/uploads/0.png','','./Public/uploads/pic/20170426144422.pngxiaotu.png','1','0','1497841660'),('11','1','123123','./Public/uploads/pic/20170426144422.png','1231231','./Public/uploads/pic/20170426144422.pngxiaotu.png','1','0','1498101347'),('14','2','我喜欢这图-----中的美女','./Public/uploads/pic/0000000.png','1236546','./Public/uploads/pic/0000000.pngxiaotu.png','1','0','1498211716');/* MySQLReback Separation */
 /* 创建表结构 `gw_role` */
