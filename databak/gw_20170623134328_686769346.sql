/* This file is created by MySQLReback 2017-06-23 13:43:28 */
 /* 创建表结构 `gw_auth` */
 ...
 DROP TABLE IF EXISTS `gw_log`;/* MySQLReback Separation */ CREATE TABLE `gw_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='登录日志';/* MySQLReback Separation */
 /* 插入数据 `gw_log` */
 INSERT INTO `gw_log` VALUES ('1','::1','中国-重庆-重庆','Chrome','Windows','3','简体中文','1498196249');/* MySQLReback Separation */
 /* 创建表结构 `gw_manager` */
